    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-muted-foreground max-w-md">Schedule posts, track engagement, and manage your social media presence across platforms. This feature is coming soon!</p>
        </CardContent>
      </Card>
    </div>
  );
